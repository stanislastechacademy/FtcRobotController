...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.2966; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 4.9; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 96 / ((95.548 + 95.793 + 95.563 + 95.66)/4); // Multiplier in the X direction
    public static double Y_MULTIPLIER = 72 / ((71.846 + 73.3)/2); // Multiplier in the Y direction
