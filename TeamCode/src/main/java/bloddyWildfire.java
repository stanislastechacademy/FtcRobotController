...
@TeleOp(name="Secret Technique No Jutsu", group="Gengar")

public class bloddyWildfire extends OpMode {
    ...
    public void loop() {
        ...
        boolean crouch = gamepad1.left_stick_button;
        ...
        telemetry.addData("Status","Mr Stoffer was here");
        telemetry.addData("Status","Mate you're not right in the head hahaha. Just use other code");
